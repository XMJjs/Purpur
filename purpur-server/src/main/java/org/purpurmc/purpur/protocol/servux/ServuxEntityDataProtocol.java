...
public class ServuxEntityDataProtocol implements PurpurProtocol {
        ...
        switch (payload.packetType) {
            ...
            case PACKET_C2S_NBT_RESPONSE_DATA -> {
                ...
                if (fullPacket != null) {
                    ...
                    PurpurLogger.LOGGER.warn("ServuxEntityDataProtocol,PACKET_C2S_NBT_RESPONSE_DATA NOT Implemented!");
                }
            }
        }
    }
    ...
    public boolean isActive() {
        return PurpurConfig.protocol.servux.entityProtocol;
    }
    ...
    public static class EntityDataPayload implements PurpurCustomPayload {
