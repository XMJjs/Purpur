...
import org.purpurmc.purpur.protocol.jade.util.ItemCollector;
import org.purpurmc.purpur.protocol.jade.util.ItemIterator;
...
public enum ItemStorageExtensionProvider implements ServerExtensionProvider<ItemStack> {
    ...
    public List<ViewGroup<ItemStack>> getGroups(Accessor<?> request) {
        ...
        try {
            ...
            PurpurLogger.LOGGER.error("Failed to get item collector for {}", target);
            return null;
        }
