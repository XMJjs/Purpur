...
public class BladerenProtocol implements PurpurProtocol {
    ...
    private static void handleHello(@NotNull ServerPlayer player, @NotNull BladerenHelloPayload payload) {
        ...
        PurpurLogger.LOGGER.info("Player {} joined with bladeren {}", player.getScoreboardName(), clientVersion);
    ...
    public boolean isActive() {
        return PurpurConfig.protocol.bladeren.enable;
    }

    public static class PurpurFeatureSet {

        private static final Map<String, PurpurFeature> features = new HashMap<>();
        ...
        public static void register(PurpurFeature feature) {
            features.put(feature.name, feature);
        }
    }

    public record PurpurFeature(String name, String value) {

        @NotNull
        @Contract("_, _ -> new")
        public static PurpurFeature of(String name, boolean value) {
            return new PurpurFeature(name, Boolean.toString(value));
        }
    ...
    public record BladerenFeatureModifyPayload(String name, CompoundTag nbt) implements PurpurCustomPayload {
    ...
    public record BladerenHelloPayload(String version, CompoundTag nbt) implements PurpurCustomPayload {
