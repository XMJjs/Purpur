package org.purpurmc.purpur.protocol.jade;
...
import org.purpurmc.purpur.plugin.PurpurInternalPlugin;
...
import org.purpurmc.purpur.protocol.jade.payload.ClientHandshakePayload;
import org.purpurmc.purpur.protocol.jade.payload.ReceiveDataPayload;
import org.purpurmc.purpur.protocol.jade.payload.RequestBlockPayload;
import org.purpurmc.purpur.protocol.jade.payload.RequestEntityPayload;
import org.purpurmc.purpur.protocol.jade.payload.ServerHandshakePayload;
import org.purpurmc.purpur.protocol.jade.provider.ItemStorageExtensionProvider;
import org.purpurmc.purpur.protocol.jade.provider.ItemStorageProvider;
import org.purpurmc.purpur.protocol.jade.provider.JadeProvider;
import org.purpurmc.purpur.protocol.jade.provider.ServerDataProvider;
import org.purpurmc.purpur.protocol.jade.provider.ServerExtensionProvider;
import org.purpurmc.purpur.protocol.jade.provider.block.*;
import org.purpurmc.purpur.protocol.jade.provider.entity.AnimalOwnerProvider;
import org.purpurmc.purpur.protocol.jade.provider.entity.MobBreedingProvider;
import org.purpurmc.purpur.protocol.jade.provider.entity.MobGrowthProvider;
import org.purpurmc.purpur.protocol.jade.provider.entity.NextEntityDropProvider;
import org.purpurmc.purpur.protocol.jade.provider.entity.PetArmorProvider;
import org.purpurmc.purpur.protocol.jade.provider.entity.StatusEffectsProvider;
import org.purpurmc.purpur.protocol.jade.provider.entity.ZombieVillagerProvider;
import org.purpurmc.purpur.protocol.jade.util.HierarchyLookup;
import org.purpurmc.purpur.protocol.jade.util.LootTableMineableCollector;
import org.purpurmc.purpur.protocol.jade.util.PairHierarchyLookup;
import org.purpurmc.purpur.protocol.jade.util.PriorityStore;
import org.purpurmc.purpur.protocol.jade.util.WrappedHierarchyLookup;
import org.purpurmc.purpur.protocol.servux.litematics.utils.NbtUtils;
...
@PurpurProtocol.Register(namespace = "jade")
public class JadeProtocol implements PurpurProtocol {
    ...
    public static void requestEntityData(ServerPlayer player, RequestEntityPayload payload) {
        Bukkit.getGlobalRegionScheduler().run(PurpurInternalPlugin.INSTANCE, (task) -> {
            ...
            for (ServerDataProvider<EntityAccessor> provider : providers) {
                ...
                try {
                    ...
                    PurpurLogger.LOGGER.warn("Error while saving data for entity {}", entity);
                }
            }
        ...
        Bukkit.getGlobalRegionScheduler().run(PurpurInternalPlugin.INSTANCE, (task) -> {
            ...
            for (ServerDataProvider<BlockAccessor> provider : providers) {
                ...
                try {
                    ...
                    PurpurLogger.LOGGER.warn("Error while saving data for block {}", accessor.getBlockState());
                }
            }
    ...
    private static void rebuildShearableBlocks() {
        try {
            ...
            PurpurLogger.LOGGER.error("Failed to collect shearable blocks");
        }
    }

    @Override
    public boolean isActive() {
        return PurpurConfig.protocol.jadeProtocol;
    }
}